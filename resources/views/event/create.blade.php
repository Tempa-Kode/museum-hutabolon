...
@section("title-page", "Tambah Data Event")
@push("styles")
                ...
                <div class="card-body">
                    <form action="{{ route('event.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="time" class="form-control" id="waktu_event" name="waktu_event" value="{{ old('waktu_event') }}" step="60">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <textarea class="form-control d-none" id="deskripsi_event" name="deskripsi_event" rows="3">{{ old('deskripsi_event') }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
